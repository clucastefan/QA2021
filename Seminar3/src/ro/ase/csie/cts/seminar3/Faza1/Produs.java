...
public class Produs {
    ...
    public float getPretFinal(TipProdus tipProdus, float pretInitial, int vechimeClientAni)
    {
        ...
        {
            pretFinal = (pretInitial - (0.1f * pretInitial)) - discoutFidelitate * (pretInitial - (0.1f * pretInitial));
        }
        else if (tipProdus == TipProdus.STOC_LIMITAT)
        {
            pretFinal = (pretInitial - (0.25f * pretInitial)) - discoutFidelitate * (pretInitial - (0.25f * pretInitial));
        }
        else if (tipProdus == TipProdus.VECHI)
        {
            pretFinal = (pretInitial - (0.35f * pretInitial)) - discoutFidelitate * (pretInitial - (0.35f * pretInitial));
        }
        return pretFinal;
    }
}